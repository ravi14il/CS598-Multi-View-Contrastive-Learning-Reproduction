...
def get_args_parser():
    ...
    parser.add_argument('--feature', default='latent', type=str)
    ...
    parser.add_argument("--extension", default=None, type=str,choices=[None, "CLS", "Weight", "CLS-Weight"],help="Model extension to use.")
